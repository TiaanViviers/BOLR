...
const char *bolr_status_string(bolr_status status) {
    switch (status) {
        ...
        case BOLR_CHECKPOINT_BAD_MAGIC: return "BOLR_CHECKPOINT_BAD_MAGIC";
        case BOLR_CHECKPOINT_UNSUPPORTED_VERSION: return "BOLR_CHECKPOINT_UNSUPPORTED_VERSION";
        case BOLR_CHECKPOINT_TRUNCATED: return "BOLR_CHECKPOINT_TRUNCATED";
        case BOLR_CHECKPOINT_CHECKSUM_MISMATCH: return "BOLR_CHECKPOINT_CHECKSUM_MISMATCH";
        case BOLR_CHECKPOINT_INVALID_DIRECTORY: return "BOLR_CHECKPOINT_INVALID_DIRECTORY";
        case BOLR_CHECKPOINT_MISSING_SECTION: return "BOLR_CHECKPOINT_MISSING_SECTION";
        case BOLR_CHECKPOINT_DUPLICATE_SECTION: return "BOLR_CHECKPOINT_DUPLICATE_SECTION";
        case BOLR_CHECKPOINT_LIMIT_EXCEEDED: return "BOLR_CHECKPOINT_LIMIT_EXCEEDED";
        case BOLR_CHECKPOINT_IO_ERROR: return "BOLR_CHECKPOINT_IO_ERROR";
